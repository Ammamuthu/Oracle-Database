@echo off
rman target / cmdfile=D:\ims_ecs\scripts\Level_1\rman_incr_cumulative_daily.rcv log=D:\ims_ecs\scripts\Level_1\logs\incr_cumulative_%date:~-4%%date:~4,2%%date:~7,2%.log
